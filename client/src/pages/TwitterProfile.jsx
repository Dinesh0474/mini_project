...
//         // Optionally, update the UI to reflect the new follow status
//       })
//       .catch(error => {
//         console.error('Error:', error);
//       });
...
//     fetch(`http://localhost:3000/unfollow/${userId}/${followingId}`, {
//       method: 'DELETE',
//       headers: {
//         'Authorization': 'Bearer ' + token,
//         'Content-Type': 'application/json'
...
//         // Optionally, update the UI to reflect the unfollow status
//       })
//       .catch(error => {
//         console.error('Error:', error);
//       });
...
//                 <img
//                   src={user.avatar} // Ensure the avatar URL is correct
//                   alt={user.name}
//                   className="w-12 h-12 rounded-full mr-2"
//                 />
//                 <div className='h-20'>
...
//                 </div>
//                 <button
//                   className="bg-white text-black hover:bg-gray-300 rounded-xl px-4 py-4 mr-7 text-sm ml-auto"
